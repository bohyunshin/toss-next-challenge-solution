...
from models.fm.deepfm import Model as DeepFM
...
class Model(DeepFM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(Model, self).__init__(
            categorical_field_dims, numerical_field_count, embed_dim, mlp_dims, dropout
        )
        ...
        total_fields = self.num_categorical + self.numerical_field_count
    ...
    def forward(self, numerical_x=None, categorical_x=None, **kwargs):
        ...
        cin_output = self._get_cin_component(numerical_x, categorical_x)

        # 3. DNN component (implicit high-order interactions) - inherited from DeepFM
        dnn_output = self._deep_component(numerical_x, categorical_x)
    ...
    def _get_cin_component(self, numerical_x, categorical_x):
        ...
        embeddings = self._get_all_embeddings(numerical_x, categorical_x)
